                ...
                children: <Widget>[
                 Padding(
                  padding:const EdgeInsets.only(top: 45.0),
                   ...
                   child:StreamBuilder(
                                    stream: FirebaseFirestore.instance.collection('orders').where("orderType", isEqualTo: "onPrepaer").snapshots(),
                                                   ...
                                                   children: <Widget>[
                                                       ...
                                                       children: [
                                                         Padding(padding: EdgeInsets.only(left: 50.0),
                                                             ...
                                                             doc(snapshot.data.docs[index].id).delete(), icon: Icon(Icons.delete))),
                                                         Padding (padding: EdgeInsets.only(left: 0.0,top: 140),
                                                             child: OutlinedButton(child: Text("send ",style: TextStyle(fontSize: 12, color: Color(0xFF3a3a3b),
                                                                 ...
                                                                 onPressed: (){
                                                         provider.sendPreparedOrderToDriver(snapshot.data.docs[index],context,snapshot.data.docs[index]['userID']);
                                                                 }    )) ,
