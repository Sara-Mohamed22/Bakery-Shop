                        ...
                        Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Selector<AdminProvider, int>(
                                    ...
                                    child: DropdownButton(
                                      ...
                                      items: snapshot.data.docs.map((DocumentSnapshot document) {
                                        ...
                                        return new DropdownMenuItem<String>(
                                            ...
                                            child: Text(" ${model.productname}",style: TextStyle(fontWeight: FontWeight.bold),),
                                        );
                                      }).toList(),
                                    ),
                                  ),
                            ...
                            Container(
                                ...
                                child: StreamBuilder<QuerySnapshot>(
                                    stream: FirebaseFirestore.instance
                                        ...
                                        .where('orderType', isEqualTo: "onPrepaer")
                                      ...
                                      if (!snapshot.hasData) {
                                        ...
                                        for (int i = 0; i < ds.length; i++) {
                                          if (!ds[i]['backeryFinish'])
                                            provider.total += toInt(ds[i]['quantity']);
                                        }
                                        ...
                                        return Container(
                                                ...
                                                height: 150,
                                                child: Text(
                                                    "Total of group ${provider.gruopName} for product is ${provider.total}",
