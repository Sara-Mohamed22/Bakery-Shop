...
OrderModel orderModel;
 return StreamBuilder(
  //stream: FirebaseFirestore.instance.collection('orders').where('userID',isEqualTo:FirestoreHelper.userId ).snapshots(),
     stream: FirebaseFirestore.instance.collection('orders').where('userID',isEqualTo:Provider.of<UserProvider>(context).currentUser.uid ).
     where('status' , whereIn: [orderStatus.begin.name , orderStatus.ready.name , orderStatus.preparing.name ,orderStatus.confirmed.name,orderStatus.delivered.name]).snapshots(),
